        ...
        children: [
          SizedBox(
            ...
            child: CachedNetworkImage(
              imageUrl: photo, fit: BoxFit.fitWidth,
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  }, icon: Icon(Icons.edit, color: Theme.of(context).colorScheme.primary, size: 33,)),),
                ),Container(
                  width: 60, height: 60,
                  decoration: BoxDecoration(
                      color: Colors.white,
                  ...
                  child: Center(child: IconButton(onPressed: (){
                    saveImage(context);
                  }, icon: Icon(Icons.save_alt, color: Theme.of(context).colorScheme.primary, size: 33,)),),
                ),
              ],
            ),
          ),
      ...
      actions: [
        TextButton(onPressed: (){
         ...
         var check = await  Wallpaper.homeScreen(
             ...
             ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Wallpaper Apply Home Screen")));
           },);
          ...
          imgStream.listen((event) {
            log(event);
             ...
             var check  = await  Wallpaper.lockScreen(
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Wallpaper Apply Lock Screen")));
                },);
               log(check);
              },
              onError: (e) {
          ...
          imgStream.listen((event) {
            log(event);
              ...
              var check = await  Wallpaper.bothScreen(
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Wallpaper Apply Both Screen")));
                },);
              log(check);
              },
              onError: (e) {
